...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [[results objectAtIndex:indexPath.row] getTransactionName]; 
	NSString *dateLabel = [[NSString alloc] initWithFormat:@"%@",[[results objectAtIndex:indexPath.row] getTransactionDate]];
