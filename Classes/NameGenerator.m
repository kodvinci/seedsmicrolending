...
-(NSString *) generateName{
    ...
    NSMutableString *name = (NSMutableString *)[nameParts objectAtIndex:(randomIntWithUpperLimit([nameParts count]))];
    [name appendString:((NSString *)[nameParts objectAtIndex:(randomIntWithUpperLimit([nameParts count]))])];
    int random = randomIntWithUpperLimit(2);
